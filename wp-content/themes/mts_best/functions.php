...
define( 'MTS_THEME_VERSION', '2.1.3' );
...
function mts_enqueue_css() {
    ...
    if($mts_options['mts_single_post_related'] == 'rclayout') {$mts_shareit_left .= '.shareit { margin: 0 0 0 -250px;}';}
    ...
    $mts_single_layout = '';
    if($mts_options['mts_single_post_related'] == 'crlayout') {
        $mts_single_layout = '
